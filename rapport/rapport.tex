...
\end{equation}
\begin{equation}
T \leftarrow User \sqsupset \Join \underset{<\underset{2}{F}.mail\_sender = u.mail \vee \underset{2}{F}.mail\_receiver = u.mail>}{} \underset{2}{F} 
\end{equation}
\begin{equation}
Result \leftarrow \pi \underset{u.*}{}(u.mail \  \  \  \sigma \underset{COUNT(*) < 3}{}T)
\end{equation}
	    \item
	    \item 
	    \item
