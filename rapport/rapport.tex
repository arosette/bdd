...
% \sqsubset : RIGHT JOIN
	...
	\begin{enumerate}
		...
		\end{equation}
		\begin{equation}
		Prop1 \leftarrow \pi \underset{publication\_url}{} (\sigma \underset{url = publication\_url \wedge stream\_url = <user>.personal\_stream\_url}{}(Propose \times Publication ))
		\end{equation}
		\begin{equation}
